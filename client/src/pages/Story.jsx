            ...
            <div className="content flex flex-col gap-5 px-4 lg:px-12">
              ...
              <div className="gap-8 pb-5 border-b border-cyan flex flex-col">
                <p className="text-sm font-normal lg:text-md leading-8">
                  So hey this is ankit.I m a govt job aspirant and here to give
                  u some backfalls, suggestions, , some queries and life after
                  govt job.I m preparing for last three years or wasted my three
                  years to get a 60k/month job. I barely study 2 hrs a day and
                  rest is god.First suggestion is that if u want to prepare for
                  such exams then never go for private bachelor degree +SSC
                  preparation for three years.because if u have that caliber
                  then u would easily crack this exam within 6 months hardcore
                  prep after completing your regular bachelors degree.I also
                  opted for 3years corresponding bachelor + SSC exam prep which
                  made me pathetic. I m a 21st century kid have no idea about
                  college culture and how they live there most fav time for 3
                  years.I think those 3 years make u emotionally
                  strong,strenghthen your mindset ,give u so much relationships
                  and fill your communication gaps.When u prepare for govt exams
                  u add no skill..u are like unskilled labour knows some englsih
                  vocabs and how to calculate faster thatsit.One of the most
                  darkest sides is the time between exam and and joining is
                  about 3 years. Which left u with no hope to prepare.and
                  bychance u didnt able to crack exam for 1st time its better to
                  start spare parts business or any other work. Though after
                  cracking govt exams u get a lot from society ,govt and lauds
                  everywhere because of the respect which is fitted in the minds
                  of traditional indian society and parents about govt job(inse
                  mt lado inka ladka daroga h delhi police mei).But i think
                  todays youngesters demand is money not daroga.then why to
                  ...
                  mind and work according to higher authorities.This is the
                  reason why they have slowest promotion rate and get salary
                  hikes at snails pace,also govt employees are not allowed to
                  involve in any other business except their jobs as they
                  already pay you in crores(parody).While if u do business,work
                  for any startup,You get idea about different zones and
                  experiences and get promotion and money according to work.You
                  search out different stratigies to keep yourself at top.So if
                  u want to prepare for UPSC then it may be ur passion but ssc
                  and other one day exams can shoot you out of the game of life.
                </p>
